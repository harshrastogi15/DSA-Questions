...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_expe = 18,                      /* expe  */
  YYSYMBOL_expt = 19,                      /* expt  */
  YYSYMBOL_expf = 20                       /* expf  */
};
...
static const char *const yytname[] =
{
  ...
  "'*'", "'/'", "'('", "')'", "$accept", "line", "assignment", "expe",
  "expt", "expf", YY_NULLPTR
};
...
#line 1184 "y.tab.c"
  ...
  case 8: /* assignment: identifier '=' expe  */
#line 30 "yacc.y"
                                  {updateSymbolVal((yyvsp[-2].id), (yyvsp[0].num));}
#line 1190 "y.tab.c"
    break;

  case 9: /* expe: expe '+' expt  */
#line 32 "yacc.y"
                              {(yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num);}
#line 1196 "y.tab.c"
    break;

  case 10: /* expe: expe '-' expt  */
#line 33 "yacc.y"
                              {(yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num);}
#line 1202 "y.tab.c"
    break;
...
#line 1208 "y.tab.c"
  ...
  case 12: /* expt: expt '*' expf  */
#line 36 "yacc.y"
                              {(yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num);}
#line 1214 "y.tab.c"
    break;

  case 13: /* expt: expt '/' expf  */
#line 37 "yacc.y"
                              {(yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num);}
#line 1220 "y.tab.c"
    break;
